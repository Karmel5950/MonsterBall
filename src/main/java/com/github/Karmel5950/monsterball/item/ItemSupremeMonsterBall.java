...
public class ItemSupremeMonsterBall extends ItemMonsterBall implements IHasModel {
    private final String name = "supreme_monsterball";
    public ItemSupremeMonsterBall(){
        super();
